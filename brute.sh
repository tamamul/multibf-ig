...
# recode tinggal recode aja okeh?, tapi cantumin source Y paman
# Yamaap kalau scriptnya berantakan
...
# thread limit => kurangin lebih kecil angkanya boleh, naikin? saran w ampun
limit=50
...
__     | _|_ o |_)|_     o (_|
||||_| |  |_ | |_)|  ___ | __|
\e[1;31mcontact: tamamjgs@gmail.com HP: 083863247010
'''
...
read -p $'Ajeng kepripun pilih 1 atau 2  : \e[1;33m' opt
